  ...
  class PageHeader extends React.PureComponent {
    ...
    render() {
      ...
      const guidesRecords = [
        ...
        {
          key: '3',
          containerId: 'guideTrigger_switchMenu',
          content: '您在这里可以‘切换菜单方案’。',
        },
        {
          key: '4',
        ...
        <div className="zj-header" style={{ width: '100%', height: '100%' }}>
          <div style={{ width: '200px', borderBottom: '1px solid #eeeff1', textAlign: 'center' }}>
            <span>
              <img
                className="logo"
                style={dataAnonymization ? { width: '118px' } : { width: '26px' }}
                src={require(dataAnonymization
                  ? '../../../../assets/apex-logo.png'
                  : '../../../../assets/apex-logo-zszq-left.png')}
                alt=""
              />
            </span>
            {!dataAnonymization && (
