...
export default class PageSider extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (pathname && pathname.includes('/pms/manage/DemandInfo')) {
      newPathname = '/pms/manage/DemandInfo';
    }
    if (pathname && pathname.includes('/pms/manage/MemberInfo')) {
      newPathname = '/pms/manage/MemberInfo';
    }
    if (pathname && pathname.includes('/pms/manage/ProjectTracking')) {
      newPathname = '/pms/manage/ProjectTracking';
    }
          ...
          >
            {
              menuTree.map(item => {
                ...
                return url !== '/noTabsPage' ? <Menu.Item key={item.url} title={item.title}><Link target={item.openType} to={item.url}>
                  <i className={`zj-submenu-ico iconfont ${item.icon || ' icon-time'}`} />
