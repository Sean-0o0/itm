...
import { FetchQueryInfoBudgetTemplateConf } from '../../../../../../../../../../../services/planning/budgetManagement';
...
class ApplyTemp extends React.Component {
  ...
  fetchTempFields = (selectedTempId, isFirst) => {
    ...
    if (selectedTempId) {
      // 查询模板详情
      FetchQueryInfoBudgetTemplateConf({
        id: selectedTempId,
        version,
        // id: 121,
        // id: 11,
  ...
  render() {
    ...
    const tempListTableProps = {
      ...
      fetch: { service: FetchQueryInfoBudgetTemplateConf, params: { id: '', paging: 0, name: searchName, version } },
