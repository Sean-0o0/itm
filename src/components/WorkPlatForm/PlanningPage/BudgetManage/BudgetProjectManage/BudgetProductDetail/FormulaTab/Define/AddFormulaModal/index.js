...
import RightContent from '../../../../../../../../WorkPlatForm/PlanningPage/Common/FormulaConfigComponent';
import { FetchQueryInfoBudgetFormulaDef, FetchOperateBudgetFormulaDef } from '../../../../../../../../../services/planning/budgetManagement';
...
class AddFormulaModal extends React.Component {
  ...
  fetchDetailData = (payFmlaId) => { // eslint-disable-line
    ...
    FetchQueryInfoBudgetFormulaDef({
      // payFmlaId: 448119,
      payFmlaId,
  ...
  handleFormSubmit = () => {
    ...
    const payload = {
      ...
      payCodeId: Number(rightData.id), // 预算项目
      payFmlaId: Number(payFmlaId), // 预算公式ID  修改删除需要传入
      payTmplId: Number(selectedTempId), // 套用模板
      version,
    };


    FetchOperateBudgetFormulaDef(payload).then((ret = {}) => {
  ...
  render() {
    ...
    return (
      <div style={{ background: '#fff' }}>
        <Row style={{ minHeight: '36rem', width: '100%', overflowY: 'auto' }}>
