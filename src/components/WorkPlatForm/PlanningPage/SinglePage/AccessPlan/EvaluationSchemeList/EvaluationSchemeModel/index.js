              ...
              <BasicModal {...modalProps}>
                ...
                <Form.Item style={{ margin: '1rem', padding: '1rem' }} label='提示' labelCol={{ span: 4 }}
                  ...
                  <div>{this.props.modalProps.type === '1' ? (<span
                    style={{ color: 'blue' }}>发起意见征求后，根据角色[反馈意见处理人]获取反馈意见的处理人员，可对反馈意见进行处理！</span>) : (this.props.modalProps.type === '2'?'提交审批后将不再允许考核方案修改及意见反馈，是否确认提交？':'发布后将不再允许考核方案修改及意见反馈，是否确认发布？')}</div>
                </Form.Item>
              </BasicModal>
