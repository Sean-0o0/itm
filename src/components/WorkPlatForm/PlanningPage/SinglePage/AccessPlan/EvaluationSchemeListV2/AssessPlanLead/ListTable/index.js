...
class ListTable extends React.Component {
    ...
    componentWillReceiveProps(nextProos) {
        ...
        const { authorities: { assessPlanLeadList = [] }, reload = false, headState } = nextProos
        ...
        const columns = [
            {
                ...
                render: (text, row, index) => {
                    ...
                    return <Link to={'/esa/planning/AesaccessPlanDetail/' + EncryptBase64(JSON.stringify(param))}>
            ...
            },
            {
                ...
                render: (text, row, index) => {
                    ...
                    node = <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        {/* 判断是否具有修改权限 */}
                        {assessPlanLeadList.includes("AssessPlanLeadUpdate") &&
                        ...
                        {assessPlanLeadList.includes("AssessPlanLeadDelete") && Number(row.status) !== -1
