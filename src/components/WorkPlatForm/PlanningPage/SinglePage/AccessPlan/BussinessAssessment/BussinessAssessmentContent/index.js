...
import { FetchQueryDefIndi, FetchAddAssessPlanLegalNote, FetchQueryLegalNote, FetchAddAssessPlan } from '../../../../../../../services/planning/planning';
    ...
    changeHeadParams = (orgId = 1, headId) => {
        ...
        this.setState({
            ...
            let param = {
                ...
                "orgId": Number(orgId),
                "planType": Number(params) === 4?1:Number(params),     //1|高管考核方案;2|业务条线;3|职能部门;4|高管助理
                "yr": year,
            }
            ...
            FetchQueryLegalNote({
                ...
                "head": headId,
                "oprType": 1,
                "planType": Number(params) === 4?1:Number(params),
                "orgId": orgId,
                "yr": year
            }).then((ret) => {
                // modularId: "6"
