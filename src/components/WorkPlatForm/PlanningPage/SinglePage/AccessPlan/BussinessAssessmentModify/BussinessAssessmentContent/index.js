...
import BussinessassessmentTable from '../../BussinessAssessment/BussinessAssessmentTable';
import QualityIndexTable from "../../BussinessAssessment/QualityIndexTable";
import EfficiencyIndexTable from "../../BussinessAssessment/EfficiencyIndexTable"
import RichTextEditor from '../../BussinessAssessmentModify/RichTextEditor'
import { FetchUpdateAssessPlan, FetchAddAssessPlanLegalNote, FetchQueryAssessPlanBusDetail, } from '../../../../../../../services/planning/planning';
...
class BussinessAssessmentContent extends React.Component {
    ...
    getData = (oprType) => {
        ...
        if (flag) {
            ...
            FetchUpdateAssessPlan(param).then((ret) => {
                if (ret.code === 1) {
                    ...
                    if (data4.length === 0) {
                        history.push(`/esa/planning/accessPlanDetail/${EncryptBase64(JSON.stringify(params))}`)
                    }
        ...
        return (
            <div id={'forWidth'} style={{ backgroundColor: 'white', padding: '0 25px 0 25px ', paddingBottom: '20px' }}>
                ...
                <Menu onClick={this.handleClick} selectedKeys={[current]} mode="horizontal" key='基础指标' >
                    <Menu.Item key="基础指标"> 基础指标</Menu.Item>
