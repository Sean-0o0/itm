...
import { FetchQuerySpecialPlanZXZB } from '../../../../../../services/planning/planning';
...
class CompanySpecialPlan extends React.Component {
  state = {
    data: [],
    dataDetail: [],
    total: 0,
  ...
  componentWillMount() {
    this.fetchQuerySpecialPlanZXZB();
  }

  fetchQuerySpecialPlanZXZB = () => {
  ...
  render() {
    ...
    return (
      <Row>
        ...
        <div style={{display: 'flex',padding:'1rem',fontSize: '1.6rem',fontWeight:'500',color: '#1F1F1F',lineHeight: '2rem'}}><div style={{width: '6px',height: '20px',background: '#30AAE4',}}></div><div style={{paddingLeft:'0.5rem'}}>专项指标</div></div>
          <BasicIndexTable
            data={data}
        ...
        <Col span={24} style={{ padding: '0 2rem' }}>
          <div style={{display: 'flex',padding:'1rem',fontSize: '1.6rem',fontWeight:'500',color: '#1F1F1F',lineHeight: '2rem'}}><div style={{width: '6px',height: '20px',background: '#30AAE4',}}></div><div style={{paddingLeft:'0.5rem'}}>专项说明</div></div>
          <BasicIndexTable
            data={dataDetail}
...
export default CompanySpecialPlan;
