...
class ListHead extends React.Component {
    ...
    render() {
        ...
        const { params,authorities: { TSPECIAL_PLAN = [] }  } = this.props
        ...
        return (
            <div className='clearfix' style={{ display: 'flex' }}>
                ...
                <div>
                    ...
                    {
                        TSPECIAL_PLAN.includes("TSPECIAL_PLAN_ADD") && <Button className="fcbtn m-btn-border m-btn-middle m-btn-border-headColor btn-1c" onClick={
