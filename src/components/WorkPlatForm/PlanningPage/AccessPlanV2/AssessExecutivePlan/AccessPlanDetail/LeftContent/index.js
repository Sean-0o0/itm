...
class LeftContent extends React.Component {
  ...
  roolbackOldPage = () => {
    ...
    getUrlParams();
    window.location.href = `/#/esa/planning/AssessExecutivePlanDetail/${EncryptBase64(JSON.stringify(params))}`;
  };
        ...
        <Col span={icon || icon2 ? 23 : 24}>
          <div className='advice-left-content'>
            <div className='advice-left-header clearfix'>
              {/* 高管的时候不显示适用业务条线 */}
              {/*{headerInfo.planType !== '1'&& headerInfo.planType !== '4' &&*/}
              ...
              <div style={{ float: 'right', marginRight: '20px' }}>
                ...
                {opr === false ? (
                  <span>
                    ...
                    <Button className='fcbtn m-btn-border m-btn-border-headColor btn-1c'
                    ><Link to={{
                      pathname: '/esa/planning/AssessExecutivePlanList',
