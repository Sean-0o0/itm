...
class LeftContent extends React.Component {
  ...
  componentDidMount() {
    ...
    if (planType === '1' || planType === '2') {
      ...
      this.fetchQueryAssessPlanFuncDetail(planId);
    }
  }
  ...
  componentWillReceiveProps(nextProps, nextContext) {
    if (nextProps !== this.props) {
      ...
      if (planType === '1' || planType === '2') {
        ...
        if (opr) {
          this.fetchQueryHisAssessPlanFuncDetail(planId);
        } else {
          this.fetchQueryAssessPlanFuncDetail(planId);
        }
      }
  ...
  //                     headerInfoArr[0] = '高管';
  //                 } else if (tmpl[1] === '2') {
  //                     headerInfoArr[0] = '适用业务条线';
  //                 } else {
  //                     headerInfoArr[0] = '适用职能部门';
  //                 }
  //             } else if (tmpl[0] === "orgName") {
  //                 headerInfoArr[1] = tmpl[1];
  //             } else if (tmpl[0] === "yr") {
  //                 headerInfoArr[2] = tmpl[1];
  //             } else if (tmpl[0] === "head") {
  //                 headerInfoArr[3] = tmpl[1];
  //             }
  //         }
  //     })
  ...
  roolbackOldPage = () => {
    ...
    getUrlParams();
    window.location.href = `/#/esa/planning/DepaccessPlanDetail/${EncryptBase64(JSON.stringify(params))}`;
  };
              ...
              <div style={{ float: 'right', marginRight: '20px' }}>
                ...
                {opr === false ? (
                  <span>
                    ...
                    <Button className='fcbtn m-btn-border m-btn-border-headColor btn-1c'
                    ><Link to={{
                      pathname: '/esa/planning/DepartmentAssessPlanList',
