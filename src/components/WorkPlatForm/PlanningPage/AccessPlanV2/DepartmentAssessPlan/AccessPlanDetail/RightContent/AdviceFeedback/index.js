    ...
    render() {
        ...
        return (
            <div className='af-box flex-c' style={{ minHeight: '50rem' }}>
                <div className='flex-r' style={{ marginLeft: '2rem',padding:'1px 1px 13px 1px'}}><span style={{ color: '#333', fontWeight: 'bold' }}>意见状态：</span>
                    ...
                    <div className='button-box' style={{float:'right',marginLeft: `${authList.indexOf("2") !== -1?(authList.indexOf("3") !== -1?'4rem':'14rem'):'14rem'}`}}>
