...
import { Form, Row, Col, Card, DatePicker, Divider } from 'antd';

const { RangePicker } = DatePicker;
class TradingUnitZYPanoramaTitle extends React.Component {
    state = {
...
export default Form.create()(TradingUnitZYPanoramaTitle);
