...
import { Row, Col, message, Form, Select, Radio, Input } from 'antd';
...
class MessagePush extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    render() {
      const { motDetail = {}, edit, codeArrList = [] } = this.props;
        ...
        <Fragment>
          <Row>
            <Form className="mot-yyb-form">
              <Form.Item>
                <Col span={8}>
                  <Form.Item label="消息栏目" labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}>
                ...
                <Col span={8}>
                  <Form.Item label="消息策略" labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}>
                ...
                <Col span={8}>
                  ...
                  <Form.Item label="有效时间" labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}>
                    <span>{yxsj}</span>小时
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item label="预发送时间" labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}>
                    <span>{sendTime}</span>
                  </Form.Item>
                </Col>

                <Col span={8}>
                  <Form.Item label="消息是否审核" labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}>

                    {

                                        edit && (motDetail.taskRqmt === '1' || motDetail.taskRqmt === '3') ? (
                                          <Radio.Group onChange={e => this.onMsgChange(e.target.value)} defaultValue={Number(motDetail.wthrRvwMsg)}>
