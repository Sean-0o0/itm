...
import { FetchqueryExamTotal, FetchqueryExamResult, FetchOperateHrPrfmScorePsrv } from "../../../../../../services/EsaServices/assessmentEvaluation";
...
class LeaderEvaluate extends Component {
    ...
    FetchqueryExamTotal(params).then(res => {
      ...
      if (code > 0 && records.length > 0) {
        ...
        this.setState({
          ...
          disabled: id !== '' || newSelected[0].flag === '0',
  ...
  render() {
    ...
    const leftCol = initialization ? columnsMinStatus ? 3 : 12 : 24;
    const rightCol = columnsMinStatus ? 21 : 12;
    return (
