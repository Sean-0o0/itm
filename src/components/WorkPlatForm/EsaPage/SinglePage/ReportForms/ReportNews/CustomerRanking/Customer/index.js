      ...
      <React.Fragment>
        <Row>
          <Col span={12} style={{ padding: '1rem' }}>
            <Row>
              <Col style={{ position: 'relative', height: '30px', lineHeight: '30px', fontWeight: '900' }}><span style={{ width: '3px', height: '10px', position: 'absolute', top: '10px', left: '-10px', backgroundColor: 'rgb(44, 170, 228)' }} />客户排名(全公司前五)</Col>
            </Row>
            <Table
          ...
          <Col span={12} style={{ padding: '1rem' }}>
            <Row>
              <Col style={{ position: 'relative', height: '30px', lineHeight: '30px', fontWeight: '900' }}><span style={{ width: '3px', height: '10px', position: 'absolute', top: '10px', left: '-10px', backgroundColor: 'rgb(44, 170, 228)' }} />客户排名(全公司后五)</Col>
            </Row>
            <Table
              className="m-table-customer m-table-bortop ant-table-wrapper"
              columns={this.businessColumns()}
