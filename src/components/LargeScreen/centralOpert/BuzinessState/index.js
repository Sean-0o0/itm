			...
			<div className="ax-card pos-r flex-c">
				...
				<div className="flex1 tc flex-c" style={{ minheight: "13rem" }}>
					<div className="flex1 co-busi-box flex-c">
						<div className="fs22 fwb">{cenOprArr[0] && cenOprArr[0].IDX_NM? cenOprArr[0].IDX_NM : '-'}</div>
						<div className="co-xzgj-num">{cenOprArr[0] && cenOprArr[0].RESULT ? parseInt(cenOprArr[0].RESULT) : '-'}&nbsp;<span className="fs16 fwn">笔</span></div>
						<div className="flex1 flex-c co-all-data">
							<div className="flex1 flex-r">
								<div className="flex1 flex-c co-all-data">
									<div className="co-data-label">{cenOprArr[1] && cenOprArr[1].IDX_NM ? cenOprArr[1].IDX_NM : '-'}</div>
									<div className="co-data-value">{cenOprArr[1] && cenOprArr[1].RESULT ? parseInt(cenOprArr[1].RESULT) : '-'}<span className="co-data-text">&nbsp;笔</span></div>
								</div>
								<div className="flex1 flex-c co-all-data">
									<div className="co-data-label red">{cenOprArr[2] && cenOprArr[2].IDX_NM ? cenOprArr[2].IDX_NM : '-'}</div>
									<div className="co-data-value red">{cenOprArr[2] && cenOprArr[2].RESULT ? parseInt(cenOprArr[2].RESULT) : '-'}<span className="co-data-text">&nbsp;笔</span></div>
								</div>
								<div className="flex1 flex-c co-all-data">
							...
							<div className="flex1 flex-r">
								...
								<div className="flex1 flex-c co-all-data">
									...
									<div className="co-data-value">{cenOprArr[6] && cenOprArr[6].RESULT ? parseInt(cenOprArr[6].RESULT) : '-'}<span className="co-data-text">&nbsp;笔</span></div>
								</div>
								<div className="flex1 flex-c co-all-data">
									<div className="co-data-label">{cenOprArr[7] && cenOprArr[7].IDX_NM ? cenOprArr[7].IDX_NM : '-'}</div>
									<div className="co-data-value">{cenOprArr[7] && cenOprArr[7].RESULT ? parseInt(cenOprArr[7].RESULT) : '-'}<span className="co-data-text">&nbsp;笔</span></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="flex1 co-busi-box flex-c">
						<div className="fs22 fwb">{cenOprArr[8] && cenOprArr[8].IDX_NM ? cenOprArr[8].IDX_NM : '-'}</div>
						<div className="co-xzgj-num">{cenOprArr[8] && cenOprArr[8].RESULT ? parseInt(cenOprArr[8].RESULT) : '-'}&nbsp;<span className="fs16 fwn">笔</span></div>
						<div className="flex1 flex-c co-all-data">
							<div className="flex1 flex-r">
								<div className="flex1 flex-c co-all-data">
