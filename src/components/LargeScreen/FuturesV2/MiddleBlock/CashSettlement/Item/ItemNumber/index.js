	...
	render() {
        ...
        {/*background: 'linear-gradient(90deg, #11276F 0%, rgba(17, 47, 111, 0) 100%)',*/}
          ...
          position: 'relative'}}>
					...
					<div className="blue1 wfb tr flex-r" style={{alignItems: 'center', width: '13rem',flexDirection: 'row-reverse'}}>笔<span style={{fontWeight: 'bold', fontSize: '2rem' }}>{item.INDEXVALUE? Number.parseInt(item.INDEXVALUE) : '-'}&nbsp;</span></div>
				</div>
			</div>
		)
	}
