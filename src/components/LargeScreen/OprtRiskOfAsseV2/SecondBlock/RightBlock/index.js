...
export class RightBlock extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (excptOrManual.length && isContinue) {
                    ...
                    <div className="h100">
                        {
                            excptOrManual.length === 0 ?
                                (<React.Fragment>
                                    ...
                                    <div className="tc pt10per blue" style={{ fontSize: '1.633rem' }}>暂无异常/手工确认指标</div>
                                </React.Fragment>) :
                                                            ...
                                                            <div className="flex-r report-title" style={{ padding: "0.5rem 2rem" }}>
                                                                <div className="fwb fs16 wid50">
                                                                    <img className={"report-top-dot"}
                                                                        ...
                                                                        alt="" />{INDEXNAME}</div>
                                                                <div className={INDEXSTATUS === '2' ? "fs18 red wid20 talr" : "fs18 orange wid20 talr"}>{INDEXSTATUSN}</div>
