...
class TaskItem extends React.Component {
  ...
  render() {
      ...
      <React.Fragment>
          <li className={boldClass} style={{fontSize:'3rem'}}>
              ...
              <div className="desc" style={{paddingLeft:'.5rem'}}>
                  ...
                  <div className='time' style={{color: '#C6E2FF',paddingLeft:current !== order ? '2rem' :''}}>{infoItem.IDX_NM ? infoItem.IDX_NM : ""}</div>
                  {
                      icon === "" ? "" :
    ...
    //         } */}
    //         <div className='time'
    //              style={{color:'#C6E2FF',paddingLeft: current !== order ? '2rem' : ''}}>{infoItem.IDX_NM ? infoItem.IDX_NM : ""}</div>
    //         {/* {
    //           icon === "" ? "" :
