    ...
    return (
      <div className=" data-list-wrap">
        <ul className=" clearfix data-list">
          <li style={{padding:'0 .466rem 0 0'}}>
            <div className=" flex-r data-item">
              {/*<div className=" data-item-left"></div>*/}
              <div className=" flex-r flex1 data-item-right">
                <div className="flex1"><img className="data-item-img" src={[require("../../../../../image/total.png")]} alt="" />全部</div>
          ...
          <li style={{padding:'0 .466rem 0 0'}}>
            <div className=" flex-r data-item">
              {/*<div className=" data-item-left"></div>*/}
              <div className=" flex-r flex1 data-item-right">
                <div className="flex1 orange"><img className="data-item-img" src={[require("../../../../../image/icon_underway.png")]} alt="" />进行中</div>
          ...
          <li style={{padding:'0 .466rem 0 0'}}>
            <div className=" flex-r data-item">
              {/*<div className=" data-item-left"></div>*/}
              <div className=" flex-r flex1 data-item-right">
                <div className="flex1 blue"><img className="data-item-img" src={[require("../../../../../image/icon_completed.png")]} alt="" />已完成</div>
          ...
          <li style={{padding:'0'}}>
            <div className=" flex-r data-item">
              {/*<div className=" data-item-left"></div>*/}
              <div className=" flex-r flex1 data-item-right">
                <div className="flex1" style={{ color:'#D34643' }}><img className="data-item-img" src={[require("../../../../../image/icon_abnormal.png")]} alt="" />异常</div>
