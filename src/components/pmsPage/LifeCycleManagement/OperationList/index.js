    ...
    render() {
        ...
        return (
            <Row style={{backgroundColor: 'white',height:'8rem'}}>
              <Col span={21} style={{height:'100%',display:'flex',alignItems: 'center',paddingLeft: '2.5rem'}}>
                <Input.Group compact>
                  <Select defaultValue="筛选">
                    <Option value="筛选">筛选</Option>
                    <Option value="筛选">筛选</Option>
                  </Select>
                  <Input.Search allowClear style={{ width: '20%' }} defaultValue="项目信息综合管理系统" />
                </Input.Group>
              </Col>
              <Col span={3} style={{height:'100%',display:'flex',alignItems: 'center',textAlign:'end',paddingRight: '3rem'}}>
