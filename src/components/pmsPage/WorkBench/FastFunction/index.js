      ...
      <div className='workBench'>
        <div className='fast-function'>
          <div className='top-box'>
            ...
            <img className='last-icon' src={require('../../../../image/pms/fastFunction/last@2x.png')} alt=''></img>
            <img className='next-icon' src={require('../../../../image/pms/fastFunction/next@2x.png')} alt=''></img>
            <Carousel afterChange={(a, b, c) => { console.log(a, b, c); }}>
              <div className='slider-box'>
                <div className='title'>
                  <span className='title-txt'>项目综合管理平台</span>
                  <div className='title-time'>11-08</div>
                  </div>
                <div className='content-box'>项目预算超过审批后可执行预算！</div>
              </div>
              <div className='slider-box'>22</div>
              <div className='slider-box'>33</div>
            </Carousel>
          </div>
