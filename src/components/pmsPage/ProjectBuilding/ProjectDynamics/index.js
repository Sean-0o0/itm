      ...
      <div className='info-prj-dynamics-card-box'>
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsXWHInfo.length > 0 && <div className='info-prj-dynamics-title'>
        ...
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsZBHInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  总办会过会
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsZBHInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsZBHInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
        ...
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsLXInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  项目立项
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsLXInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsLXInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
        ...
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsHTInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  合同签署完成
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsHTInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsHTInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {
              prjDynamicsHTInfo.length > 0 && <div className='info-prj-dynamics-footer'>
                查看详情<i class="iconfont icon-right"/>
              </div>
            }
          </div>
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsSXInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  项目上线
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsSXInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsSXInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
        ...
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsFKInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  项目付款
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsFKInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsFKInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
        ...
        }
        {
          ...
          <div className='info-prj-dynamics-card'>
            {
              prjDynamicsWJInfo.length > 0 && <div className='info-prj-dynamics-title'>
                <div className='info-prj-dynamics-title-left'>
                  项目完结
                </div>
                <div className='info-prj-dynamics-title-right'>
                  <div className='info-prj-dynamics-title-right-box'>
                    <div className='info-prj-dynamics-title-right-time'>
                      今年：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsWJInfo[0].JNSL}个
                      </div>
                    </div>
                    <div style={{paddingLeft: '8px'}} className='info-prj-dynamics-title-right-time'>
                      近一周：
                      <div className='info-prj-dynamics-title-right-num'>
                        {prjDynamicsWJInfo[0].JYZSL}个
                      </div>
                    </div>
                  </div>
                </div>
