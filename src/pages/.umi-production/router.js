...
import RendererWrapper0 from '/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/pages/.umi-production/LocaleWrapper.jsx';
...
const routes = [
  {
    ...
    component: __IS_BROWSER
      ? _dvaDynamic({
          ...
          LoadingComponent: require('/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/components/Loader/Loader')
            .default,
        })
    ...
    routes: [
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              ...
              models: () => [
                import(/* webpackChunkName: 'p__homePageV2__models__homePage.js' */ '/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/pages/homePageV2/models/homePage.js').then(
                  m => {
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              component: () =>
                import(/* webpackChunkName: "p__intergration__iframeContent" */ '../intergration/iframeContent'),
              LoadingComponent: require('/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/components/Loader/Loader')
                .default,
            })
          : require('../intergration/iframeContent').default,
        exact: true,
      },
      {
        path: '/WorkProcessor**',
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              component: () =>
                import(/* webpackChunkName: "p__intergration__reactIframe" */ '../intergration/reactIframe'),
              LoadingComponent: require('/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/components/Loader/Loader')
                .default,
            })
          : require('../intergration/reactIframe').default,
        exact: true,
      },
      {
        path: '/staffAdmission',
        component: __IS_BROWSER
          ? _dvaDynamic({
              app: require('@tmp/dva').getApp(),
              models: () => [
                import(/* webpackChunkName: 'p__workPlatForm__mainPage__businessNavigate__models__staffAdmission.js' */ '/Applications/code/cxyw/xyzq/pc/pro-cv-fe/src/pages/workPlatForm/mainPage/businessNavigate/models/staffAdmission.js').then(
                  m => {
