...
import AddIndHeader from '../../../../../../components/WorkPlatForm/PlanningPage/SinglePage/AccessPlan/AddInd/AddIndHeader'
import AddIndBody from '../../../../../../components/WorkPlatForm/PlanningPage/SinglePage/AccessPlan/AddInd/AddIndBody'
...
class AddInd extends React.Component {
    ...
    componentWillMount() {
        ...
        const { orgId = '', planId = '' } = this.getUrlParams();
        this.setState({
            orgId: orgId,
            planId: planId
        })
    ...
    render() {
        ...
        let { mon, orgName, planId, data, orgId } = this.state
        return (
            <Fragment>
                <div style={{ padding: '0 25px' }} >
                    <Row style={{ height: '100%' }} className='dp-body'>
                        <Col span={24} className='dp-title'>
                            <AddIndHeader handleMonthPickerOnChange={this.handleMonthPickerOnChange} orgName={orgName} />
                        </Col>
                        <Col span={24} className='dp-cont'>
                            <AddIndBody orgId={orgId} mon={mon} data={data} planId={planId} changeData={this.changeData} onSubmitOperate={onSubmitOperate} onCancelOperate={onCancelOperate} />
                        </Col>
                    </Row>
                </div>
            </Fragment>
