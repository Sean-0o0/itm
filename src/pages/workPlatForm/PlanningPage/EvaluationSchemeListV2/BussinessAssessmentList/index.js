...
import EvaluationSchemeList from '../../../../../components/WorkPlatForm/PlanningPage/SinglePage/AccessPlan/EvaluationSchemeListV2/BussinessAssessment'
class BussinessAssessmentList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
