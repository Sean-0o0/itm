...
import LeftContent from '../../../../../components/WorkPlatForm/PlanningPage/BusAccessPlan/BusAccessPlanDetail/LeftContent';
...
class BusResponDetail extends React.Component {
  state = {
    planId: '',
    planType: '',
    planStatus:'',
