...
class ManageServiceStaff extends React.Component {
  constructor(props) {
    super(props);
         ...
         <div style={{ height, overflow: 'hidden' }}>
          <Row className="m-row">
            <Col xs={24} sm={24} lg={24} xl={24} style={{ marginBottom: '2px' }}>
              {/* 搜索公共组件 */}
              <SalaryAppraisalSearch leftTile="管理服务人员考核薪酬" {...commonProps} chooseMonth={this.chooseMonth} chooseOrg={this.chooseOrg} />
            </Col>
          </Row>
