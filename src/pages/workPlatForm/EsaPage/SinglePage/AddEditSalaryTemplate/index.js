...
import FormulaConfigComponent from '../../../../../components/Common/FormulaConfigComponent';
import { FetchqueryInfoSalaryTemplateConf, FetchoperateSalaryTemplateConf } from '../../../../../services/EsaServices/salaryManagement';
import LeftContent from './LeftContent';

/**
 * 薪酬模板的新增和修改
 */
class AddEditSalaryTemplate extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      info: [],
  ...
  myForm = async (values) => {
    ...
    await FetchoperateSalaryTemplateConf({
  ...
  render() {
    const { info, salaryTemplateConfData, params, Variable, selectIndex, inputChangIndex, inputIndex } = this.state;
