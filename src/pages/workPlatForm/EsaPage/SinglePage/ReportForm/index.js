...
import { FetchReportTemplateInfo, FetchReportTemplateSetting } from '../../../../../services/EsaServices/reportCenter';
        ...
        {/* <LBDialog trustedOrigin="*"> */}
          ...
          >
            <Form className="m-form">
              <FormItem
                {...formItemLayout}
                label={<span style={{ fontSize: '1.2rem', fontWeight: 600 }}><span style={{ color: 'red' }}>*</span>&nbsp;报表名称</span>}
              >
                <div style={{ width: '500px' }}><Input placeholder="请输入报表名称" value={rptNm} onChange={this.inputChange} /></div>
              </FormItem>
              <FormItem
                {...formItemLayout}
                label={<span style={{ fontSize: '1.2rem', fontWeight: 600 }}><span style={{ color: 'red' }}>*</span>&nbsp;扩展页面编码</span>}
              >
                <div style={{ width: '500px' }}><Input placeholder="请输入扩展页面编码" disabled={optTp === '2'}  value={rptCode} onChange={this.inputCodeChange} /></div>
              </FormItem>
              <FormItem
                {...formItemLayout}
                label={<span style={{ fontSize: '1.2rem', fontWeight: 600 }}>参考模板</span>}
              >
                <div style={{ width: '500px', display: 'flex' }}>
                  ...
                  {
                    tmplPicId !== '' && (<div style={{ paddingLeft: '0.5rem' }}><Link to={`/single/esa/imgPreview/TC_REPO_CENT_TMPL,prePic,${tmplPicId}`} target="_blank" className="blue"><EyeOutlined />&nbsp;预览</Link></div>)
                  }
                </div>
              </FormItem>
              <FormItem
                {...formItemLayout}
                label={<span style={{ fontSize: '1.2rem', fontWeight: 600 }}><span style={{ color: 'red' }}>*</span>&nbsp;报表JSON</span>}
              >
              ...
              <FormItem
                {...formItemLayout}
                label={<span style={{ fontSize: '1.2rem', fontWeight: 600 }}>说明</span>}
              >
